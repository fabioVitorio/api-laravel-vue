            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 space-y-4">
                ...
                <div v-else>
                    <div v-for="task in tasks" :key="task.id"
                        class="flex items-center justify-between border border-gray-200 rounded-lg p-4 hover:shadow-md transition mb-4">
                        <div v-for="task in tasks" :key="task.id" class="p-4 rounded-lg">
